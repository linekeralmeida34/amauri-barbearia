        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button 
                size="lg" 
                variant="outline"
                className="border-white text-white hover:bg-white hover:text-barbershop-dark font-semibold text-lg px-8 py-6 transition-all duration-300"
              >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 text-center text-white border border-white/20 col-span-2">
              ...
              <div className="text-2xl font-bold">5 Barbeiros</div>
